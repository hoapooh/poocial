...
function ProfileSection({ user, posts, likedPosts, isCurrentUserFollowing }: ProfileSectionProps) {
               ...
               data-[state=active]:bg-transparent px-6 font-semibold"
					...
					<TabsContent value="posts" className="mt-6">
						<div className="space-y-6">
							{posts.length > 0 ? (
								posts.map((post) => (
									<PostCard key={post.id} post={post} dbUserId={user.id} urlPath={"/profile"} />
								))
							) : (
